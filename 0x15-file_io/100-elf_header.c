...
* @e_ident: the pointer which contains the ELF ABI version
*/
...
/**
* print_type - displays the type of ELF header
* @e_type: the type of ELF to be displayed
* @e_ident: the pointer which contains an ELF
*/
...
/**
* print_entry - output the entry point of an ELF header
* @e_entry: the address of an ELF
* @e_ident: the pointer which contains the ELF
*/
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
...
/**
* main - prints out all the content of the ELF header at the start of file
* @argc: the toal number of arguments to be passed
* @argv: an array of pointers
*
* Return: always success
*
* Description: if the file is not an ELF file or it fails - exit code 98
*/
